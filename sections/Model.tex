...
\noindent
where every node $z_i$ can be vector-valued and $\text{concat}$ is simply the concatenation over the parent set. The formalism relates straightforwardly to the forward propagation of neural networks.
