...
\end{algorithmic}
\noindent
the name relates to the rewinding of the forward propagation. With the pre-evaluated input, the error is pushed back through the NN. As can be seen backpropagation through time starts from $t=T$ down to one.
