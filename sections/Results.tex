...
\begin{table}[h]
    \centering
    \begin{tabular}{lllll}
    \multicolumn{1}{|l}{} 27 & 37 & 47 & 57 & 67 \\
    \hline
    \multicolumn{1}{|l}{} 6.82 & 11.98 & 7.66 & 5.54 & 3.74 \\
    \multicolumn{1}{|l}{} 5.73 & 5.53 & 5.75 & 6.46 & 4.99 \\
    \end{tabular}
    \caption{Accuracy in \%}
    \label[table]{acc_t}
\end{table}

In the table \ref{acc_t} the accuracy can be seen in plain text.
