...
\begin{figure}[h]
    ...
    \caption{Error on test set.}
    \label[fig]{acc}
\end{figure}

In the last plot of the error on the test set \ref{acc} with and without the algorithm, which seems to perform well for small to medium sized NNs.
