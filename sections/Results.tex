...
In figures, w in the legends stands for with the algorithm. 
...
As can be seen, a plot of energy during training. Fig \ref{E} on the current mini-batch and \ref{E_sel} on the selection set. The variation is due to the mini-batch being a small subset. However, these plots are dense in data, and thus averages and standard deviations are also included. 
