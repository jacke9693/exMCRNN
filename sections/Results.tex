...
As can be seen, an accuracy of the different RNNs after training.

As can be seen, a plot of energy during training. One on the selection set and one on the current mini-batch.
