...
In the Tbl. \ref{acc_t}, the error can be seen in plain text, with and without the regularization. Here a clear increase is seen for small to medium-sized RNNs is seen with MCR.
