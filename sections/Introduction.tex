...
\begin{figure}[h]
    ...
    \end{neuralnetwork}
    \caption{A feedforward network, with a single hidden layer. The input proceeds from left to right.}
    \label[fig]{feed}
\end{figure}
